          ...
          <div className="max-w-container-max mx-auto px-margin-desktop">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8 border border-border-subtle">
                ...
                {/*
                  Les coordonnées bancaires ne transitent jamais par ce formulaire :
                  la saisie de carte se fait sur la page hébergée du prestataire de
                  paiement, seul cadre conforme PCI DSS. Ce bloc ne recueille que
                  l'identité du souscripteur.
                */}
                <form className="space-y-6" action="/api/souscription" method="post">
                  <div>
                    <label
                      htmlFor="societe"
                    ...
                    <input
                      ...
                      className="w-full bg-surface-gray border border-border-subtle rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
                    />
                  </div>
                  <div>
                    <label
                  ...
                  <div className="flex items-start gap-3 p-4 rounded-lg bg-surface-gray border border-border-subtle">
                    ...
                    <p className="text-body-md text-text-muted">
                      Le paiement s&apos;effectue à l&apos;étape suivante, sur la page sécurisée de
                      notre prestataire. Aucune donnée bancaire n&apos;est saisie ni stockée sur ce
                      site.
                    </p>
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full py-4 rounded-xl bg-vibrant-orange text-white font-bold text-headline-md shadow-lg shadow-vibrant-orange/20 hover:scale-[1.02] active:scale-95 transition-all"
                  >
